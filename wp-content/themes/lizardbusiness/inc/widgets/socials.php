...
<?php
    ...
    $social_profiles_defaults = array(
        ...
        'profiles' => array(
        array('id'=>'twitter', 'title' => 'Twitter', 'url' => 'http://twitter.com/', 'button' => get_template_directory_uri() . '/images/socials/twitter.png'),
        array('id'=>'facebook','title' => 'Facebook', 'url' => 'http://facebook.com/', 'button' => get_template_directory_uri() . '/images/socials/facebook.png'),
        array('id'=>'gplus','title' => 'Google Plus', 'url' => 'https://plus.google.com/', 'button' => get_template_directory_uri() . '/images/socials/gplus.png'),
        array('id'=>'linkedin','title' => 'LinkedIn', 'url' => 'http://www.linkedin.com/', 'button' => get_template_directory_uri() . '/images/socials/linkedin.png'),
        array('id'=>'rss','title' => 'RSS Feed', 'url' => '', 'button' => get_template_directory_uri() . '/images/socials/rss.png'),
        array('id'=>'email','title' => 'Email', 'url' => 'mailto:your@email.com', 'button' => get_template_directory_uri() . '/images/socials/email.png'),
		array('id'=>'pinterest','title' => 'Pinterest', 'url' => 'http://pinterest.com', 'button' => get_template_directory_uri() . '/images/socials/pinterest.png')
		)
    );
...
class lzSocialProfiles extends WP_Widget 
{
    function __construct(){
        
        $widget_options = array('description' => 'Add buttons to your social network profiles.' );
        $control_options = array();
        parent::__construct('lzSocialProfiles', '&raquo; Social Profiles', $widget_options, $control_options);
    }
        ...
        <div class="sp_new_<?php echo $get_this_id?>">
			<?php
				if (is_array($profiles)) {
					...
					<span class='title'><?php echo $values['title']?><img src='<?php echo get_template_directory_uri()?>/inc/images/social_remove.png' title='Delete' style='float:right' class='profile_delete' /></span>
			...
			<div class="new_profile_container_<?php echo $get_this_id?>" style="display: none;">
				<div class='new_profile'>
					<span class='title'>Title<img src='<?php echo get_template_directory_uri()?>/inc/images/social_remove.png' title='Delete' style='float:right' class='profile_delete' /></span>
					<div>
						<div>
							<a class='social_presets_btn' style='float:right' >Presets</a>
				...
				<div class='social_presets'>
							<table width='100%'>
								<tr>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/twitter.png' alt='twitter' title='Twitter' /></td>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/facebook.png' alt='facebook' title='Facebook' /></td>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/gplus.png' alt='gplus' title='Google plus' /></td>
								</tr>
								<tr>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/linkedin.png' alt='linkedin' title='Linkedin' /></td>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/rss.png' alt='rss' title='Rss' /></td>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/email.png' alt='email' title='Email' /></td>
								</tr>
								<tr>
									<td><img src='<?php echo get_template_directory_uri()?>/images/socials/livejournal.png' alt='livejournal' title='Twitter' /></td>
								</tr>
							</table>
						</div>
            </div>
...
add_action('widgets_init', create_function('', 'return register_widget("lzSocialProfiles");'));
?>
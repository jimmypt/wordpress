...
class lzVideoFeed extends WP_Widget 
{
    function __construct(){
        
        $widget_options = array('description' => 'Video Feed Box widget.' );
        $control_options = array();
        parent::__construct('lzVideoFeed', '&raquo; Video Feed', $widget_options, $control_options);
    }
...
add_action('widgets_init', create_function('', 'return register_widget("lzVideoFeed");'));
?>